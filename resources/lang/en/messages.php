...
return [
    ...
    'must_wait_to_train'                                    => 'You must wait :time_remaining to be able to train again.',
    ...
    'training_streak_lost'                                  => 'You have lost your training streak of <strong>:trainning_count trainings</strong>, do you want to use <strong>1 Fúlbo</strong> to keep the streak or start a new streak?',
